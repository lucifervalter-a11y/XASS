# -*- coding: utf-8 -*-
"""Vendored VK audio URL decoder (from python273/vk_api, MIT).

Decodes the encrypted "audio_api_unavailable.mp3?extra=...#..." URLs that
audio.get / audio.getById return for third-party tokens into direct CDN links.
"""
...
def decode_audio_url(string, user_id):
    if "?extra=" not in string:
        raise VkAudioUrlDecodeError("not an encrypted vk audio url")

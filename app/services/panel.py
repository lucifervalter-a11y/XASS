...
def main_panel_keyboard() -> dict:
    return {
        "inline_keyboard": [
            ...
            [
                {"text": "🗂 Проекты", "callback_data": "panel:projects"},
                {"text": "🆕 Обновление", "callback_data": "panel:update"},
            ],
        ]
    }
...
def panel_text() -> str:
    return (
        ...
        "Быстрые команды:\n"
        ".muz / .music — текущий трек\n"
        ".weather      — погода\n"
        ".mute         — замолчать чат\n"
        ".unmute       — снять мут\n"
        ".help         — все команды\n\n"
        "/webapp — 📱 мини-приложение XASS\n"
...
def dot_commands_help_text() -> str:
    return (
        "Команды бота\n"
        "════════════\n\n"
        "🎵 Музыка\n"
        ".muz              — показать текущий трек\n"
        ".muz <запрос>     — найти трек по названию\n"
        ".music            — то же, что .muz\n\n"
        "🌤 Погода\n"
        ".weather          — погода в сохранённой локации\n"
        ".weather <город>  — погода в любом городе\n\n"
        "🔇 Мут\n"
        ".mute             — включить мут в этом чате (только владелец)\n"
        ".unmute           — выключить мут (только владелец)\n\n"
        "💬 Цитаты сайта\n"
        "/quote <текст>    — добавить цитату\n"
        "/quotes           — список цитат\n"
        "/quotedel <id>    — удалить цитату\n\n"
        "————————————————————————\n"
        ".help   — эта справка\n\n"

...
<p align="center">
  <img alt="Server 0.16.0" src="https://img.shields.io/badge/server-0.16.0-3b82f6?style=flat-square">
  <img alt="Windows agent 0.16.0" src="https://img.shields.io/badge/Windows_agent-0.16.0-2563eb?style=flat-square&logo=windows11&logoColor=white">
...
- Нативная [iOS‑оболочка](./ios/README.md): фоновый AVPlayer, локальные загрузки, AirPlay, Face ID или системный код после первоначальной привязки. [Неподписанный IPA требует переподписи](./ios/UNSIGNED.md).
